...
function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-white via-gray-50 to-gray-100 py-24 lg:py-32">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="inline-flex items-center bg-white/80 backdrop-blur-sm rounded-full px-6 py-3 mb-8 border border-gray-200 shadow-sm">
              <i className="fas fa-brain w-5 h-5 mr-3 text-indigo-600"></i>
              <span className="text-sm font-medium text-gray-700">Intelligent Career Matching Platform</span>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center mb-16">
              <button className="group bg-indigo-600 hover:bg-indigo-700 text-white px-10 py-4 rounded-lg font-semibold text-lg transition-all duration-300 flex items-center shadow-lg hover:shadow-xl">
                Find Opportunities
                <i className="fas fa-chevron-right w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform"></i>
              </button>
              <button className="group border-2 border-gray-300 hover:border-gray-400 text-gray-700 hover:text-gray-900 bg-white hover:bg-gray-50 px-10 py-4 rounded-lg font-semibold text-lg transition-all duration-300 flex items-center shadow-sm hover:shadow-md">
                Upload Resume
                ...
                <div className="bg-white border border-gray-200 rounded-xl shadow-lg p-2">
                  <div className="flex items-center">
                    ...
                    <input
                      ...
                      className="flex-1 px-4 py-4 bg-transparent text-gray-900 text-lg focus:outline-none placeholder-gray-500"
                    />
                    <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-4 rounded-lg font-semibold transition-colors duration-300">
                      Search Jobs
                    </button>
                  </div>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {[
              { icon: Users, number: '25,000+', label: 'Active Professionals', color: 'text-indigo-600' },
              { icon: Building2, number: '5,000+', label: 'Partner Companies', color: 'text-gray-600' },
              { icon: Database, number: '15,000+', label: 'Job Openings', color: 'text-indigo-600' },
              { icon: TrendingUp, number: '94%', label: 'Success Rate', color: 'text-gray-600' }
            ].map((stat, index) => (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="group">
                <div className="bg-white rounded-xl p-8 hover:bg-gray-50 transition-all duration-300 border border-gray-200 hover:border-gray-300 h-full shadow-sm hover:shadow-md">
                  <div className={`${feature.bgColor} w-16 h-16 rounded-lg flex items-center justify-center mb-6 border border-gray-200`}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className="text-center">
                <div className="bg-indigo-600 w-20 h-20 rounded-xl flex items-center justify-center mx-auto mb-8 shadow-lg">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center">
              <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-10 py-4 rounded-lg font-semibold text-lg transition-colors duration-300 shadow-lg hover:shadow-xl">
                Get Started Today
              </button>
              <button className="border-2 border-gray-300 hover:border-gray-400 text-gray-700 hover:text-gray-900 bg-white hover:bg-gray-50 px-10 py-4 rounded-lg font-semibold text-lg transition-all duration-300 shadow-sm hover:shadow-md">
                Learn More
              </button>
            </div>
          </div>
